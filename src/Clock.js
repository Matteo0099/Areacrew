! function (t, n) {
    var e, r, o = void 0 === window.rum,
        a = void 0 === t.TZ24Widgets;
    a || o ? (parseInt("1", 10) > 0 && o && (window.rum = function (t) {
        window.rum.key = t
    }, e = document.createElement("script"), r = document.getElementsByTagName("script")[0], e.async = 1, e.src = "https://cdn.perfops.net/rom3/rom3.min.js", r.parentNode.insertBefore(e, r), rum("63ec29")), a && (t.TZ24Widgets = function () {
        "use strict";
        var t = "a",
            n = "d",
            e = "db",
        ...
        function s(t, n) {
            ...
            return i(n, "toString") && (t.toString = n.toString), i(n, "valueOf") && (t.valueOf = n.valueOf), t
        }
        var c, u = function () {
            ...
            1: [function (t, n, e) {
                ...
                function o(t) {
                    if ("object" != typeof t) throw new TypeError("Unrecognized argument");
                    if (!t.vData) throw new TypeError('Data object should include filter data "vData"');
                    if (t.vData.length > 8 * o.MAX_BLOOM_FILTER_SIZE) throw new TypeError('"vData" exceeded max size "' + o.MAX_BLOOM_FILTER_SIZE + '"');
                    if (this.vData = t.vData, !t.nHashFuncs) throw new TypeError('Data object should include number of hash functions "nHashFuncs"');
                    if (t.nHashFuncs > o.MAX_HASH_FUNCS) throw new TypeError('"nHashFuncs" exceeded max size "' + o.MAX_HASH_FUNCS + '"');
                    this.nHashFuncs = t.nHashFuncs, this.nTweak = t.nTweak || 0, this.nFlags = t.nFlags || o.BLOOM_UPDATE_NONE
                }
                o.prototype.toObject = function () {
                    ...
                    return l > o.MAX_HASH_FUNCS && (l = o.MAX_HASH_FUNCS), l < o.MIN_HASH_FUNCS && (l = o.MIN_HASH_FUNCS), a.nHashFuncs = l, a.nTweak = e, a.nFlags = r, new o(a)
                }, o.prototype.hash = function (t, n) {
                    var e = r(4221880213 * t + this.nTweak & 4294967295, n);
                    ...
                    return "<BloomFilter:" + this.vData + " nHashFuncs:" + this.nHashFuncs + " nTweak:" + this.nTweak + " nFlags:" + this.nFlags + ">"
                }, o.BLOOM_UPDATE_NONE = 0, o.BLOOM_UPDATE_ALL = 1, o.BLOOM_UPDATE_P2PUBKEY_ONLY = 2, o.MAX_BLOOM_FILTER_SIZE = 36e3, o.MAX_HASH_FUNCS = 50, o.MIN_HASH_FUNCS = 1, o.LN2SQUARED = Math.pow(Math.log(2), 2), o.LN2 = Math.log(2), n.exports = o
            }, {
                "./murmurhash3": 2
            }],
            2: [function (t, n, e) {
                n.exports = function (t, n) {
                    ...
                    function i(t, n) {
                        return (65535 & t) * n + (((t >>> 16) * n & 65535) << 16) & 4294967295
                    }

                    function s(t, n) {
                        return t << n | t >>> 32 - n
                    }
                    for (var c = 0; c + 4 <= n.length; c += 4) e = i(e = s(e = i(e = n[c] | n[c + 1] << 8 | n[c + 2] << 16 | n[c + 3] << 24, r), 15), o), a = i(a = s(a ^= e, 13), 5), a = (65535 & (u = a)) + ((l = 1801774676) >>> 16) + (((u >>> 16) + l & 65535) << 16) & 4294967295;
                    var u, l;
                    switch (e = 0, 3 & n.length) {
                        ...
                        case 2:
                            e ^= n[c + 1] << 8;
                        case 1:
                            e = i(e = s(e = i(e ^= n[c], r), 15), o), a ^= e
                    }
                    return a ^= n.length, a = i(a ^= a >>> 16, 2246822507), a = i(a ^= a >>> 13, 3266489909), (a ^= a >>> 16) >>> 0
                }
            }, {}],
            "bloom-filter": [function (t, n, e) {
                n.exports = {}, n.exports = t("./filter"), n.exports.MurmurHash3 = t("./murmurhash3")
            }, {
                "./filter": 1,
                "./murmurhash3": 2
            }]
        ...
        function S(t) {
            ...
            if (e.length > 3 && "tz24" == e[0]) {
                var r = {};
                return r.generated = e[1], r.loc = e[2], n = t.replace(e[0] + "-" + e[1] + "-" + e[2] + "-", ""), r.config = JSON.parse(window.atob(n)), r
            }
            return 0
        }
        ...
        function D(t) {
            var n, e = function (t) {
                var n, e = [],
                    r = [],
                    o = [];
                for (n in t) e.push(t[n].loc), -1 == r.indexOf(t[n].config.type) && r.push(t[n].config.type), -1 == o.indexOf(t[n].config.lang) && o.push(t[n].config.lang);
                if (e.length > 0 && r.length > 0) return ("file:" == location.protocol ? "https:" : location.protocol) + "//w.24timezones.com/c.js?l=" + encodeURIComponent(e.join(",")) + "&t=" + encodeURIComponent(r.join(",")) + "&lang=" + encodeURIComponent(o.join(","));
                return !1
            }(t);
            if (!1 !== e) {
                var r = document.createElement("script");
                r.type = "text/javascript", r.src = e, r.readyState ? r.onreadystatechange = function () {
                    "loaded" !== r.readyState && "complete" !== r.readyState || (r.onreadystatechange = null, w += Date.now() - n)
                } : r.onload = function () {
                    w += Date.now() - n
                }, r.onerror = function () {
                    console.error("Error loading data for 24tz widget")
                }, n = Date.now(), document.getElementsByTagName("head")[0].appendChild(r)
            }
        }

        function T(t) {
            v = !0, t.media = "all";
            for (var n = document.getElementsByClassName("w24tz-current-time"), e = 0, r = n.length; e < r; e++) n[e].style.cssText += "visibility: visible !important;"
        }

        function M() {
            var t, n, e, o, a, i, s, u, l = !1,
                h = {},
                p = Date.now() - c + m;
            for (var y in f) t = f[y].loc, typeof (n = d[t]) !== r && (o = 1e3 * parseInt(n.raw_offset, 10), a = 1e3 * parseInt(n.dst_offset, 10), i = 1e3 * parseInt(n.dst_starts, 10), s = 1e3 * parseInt(n.dst_ends, 10), u = n.tz_info || {}, n.has_transitions ? i && s && (i < s ? i <= p && p < s ? (e = p + w + a, l = !0) : e = p + w + o : p < s || p >= i ? (e = p + w + a, l = !0) : e = p + w + o) : e = p + w + o, !1 === l && "standard" in u ? h = u.standard : !0 === l && "dst" in u && (h = u.dst), "compound" in u && "alias" in h && (h.alias = u.compound.alias), y in g && (v ? g[y].render.call(g[y], e, h) : !g[y].waitForCss.call(g[y]) && g[y].render.call(g[y], e, h)));
            setTimeout(M, p % 1e3 == 0 ? 1e3 : Math.abs(1e3 * Math.ceil(p / 1e3) - p))
        }
        ...
        function A() {
            ...
            f = function (t) {
                ...
                return r
            }(t), 0 === e.indexOf("www.") && (e = e.replace("www.", "")), n.contains(function (t) {
                if (window.TextEncoder) return new TextEncoder("utf-8").encode(t);
                for (var n = new Uint8Array(t.length), e = 0; e < t.length; e++) n[e] = t.charCodeAt(e);
                return n
            }(e)) || function (t, n, e) {
                for (var r = 0, o = t.length; r < o; r++) null !== e ? t[r].id in n && "generated" in n[t[r].id] ? n[t[r].id].generated <= 1561939200 && t[r].setAttribute("rel", e) : t[r].setAttribute("rel", e) : t[r].removeAttribute("rel")
            }(t, f, "nofollow"), D(f), -1 !== function (t) {
                var n, e = [];
                for (n in t) - 1 == e.indexOf(t[n].config.type) && e.push(t[n].config.type);
                return e
            }(f).indexOf("db") && function () {
                if (0 === p.length) {
                    var t = document.createElement("link");
                    t.rel = "stylesheet", t.type = "text/css", t.href = ("file:" == location.protocol ? "https:" : location.protocol) + "//w.24timezones.com/css/clock_widget.css", t.media = "none", t.readyState ? t.onreadystatechange = function () {
                        T(t)
                    } : t.onload = function () {
                        T(t)
                    }, document.getElementsByTagName("head")[0].appendChild(t), p.push(t)
                }
            }()
        }
        var b = function () {
            var t, n, e, r = Date.now();
            "interactive" === document.readyState || "complete" === document.readyState ? A() : (t = document, n = "DOMContentLoaded", e = function () {
                w = Date.now() - r, A()
            }, t.addEventListener ? t.addEventListener(n, e) : t.attachEvent && t.attachEvent("on" + n, e))
        };
        return b.defineLocale = function (t, n) {
            if (null === n) return delete l[t], null;
            var e = O;
            n.abbr = t, l[t] = new F(function (t, n) {
                var e, r = s({}, t);
                for (e in n) i(n, e) && (a(t[e]) && a(n[e]) ? (r[e] = {}, s(r[e], t[e]), s(r[e], n[e])) : null != n[e] ? r[e] = n[e] : delete r[e]);
                for (e in t) i(t, e) && !i(n, e) && a(t[e]) && (r[e] = s({}, r[e]));
                return r
            }(e, n))
            ...
            (function () {
                var o, a, i;
                for (var s in f) a = f[s].loc, o = "type" in f[s].config ? f[s].config.type : null, i = "lang" in f[s].config ? f[s].config.lang : "en", typeof d[a] !== r && (d[a], t == o ? g[s] = new h[o](document.getElementById(s), f[s].config) : n != o && e != o || (g[s] = new h[o](document.getElementById(s), f[s].config, l[i])))
            })(), c = Date.now(), M()
        }, b.setServerTime = function (t) {
            m = Math.round(1e3 * parseFloat(t))
        }, b
    }(), t.TZ24Widgets())) : TZ24Widgets.setServerTime("1670096247.2375")
}(this);